...
func registerFlags() {
	...
	flag.StringVar(&e2eContext.HostedInstallNamespace,
		...
		"",
		"Per-managed-cluster install namespace on the hosting cluster, required when --hosting-cluster-name is set.")
}
...
func validateFlags() {
	...
	// otherwise IsHostedMode collapses to false and the hosted setup is skipped.
